    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Data download failed:', error_1.message);
                    return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Data download failed:', error_2.message);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
...
function readData() {
    try {
        var jsonData = localStorage.getItem('style');
...
function readFunctions() {
    try {
        var jsonData = localStorage.getItem('functions.json');
        var functions = JSON.parse(jsonData || '');
        return functions;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    data = readFunctions();
                    if (!!data) return [3 /*break*/, 2];
                    return [4 /*yield*/, init_functions(url)];
                case 1:
                    _a.sent();
                    return [2 /*return*/, readFunctions()];
                case 2:
